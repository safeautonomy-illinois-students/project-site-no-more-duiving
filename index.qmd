...
- **Heading Error ($\psi_e$):** difference between vehicle orientation and lane direction  
- **Cross-Track Error ($e$):** lateral distance from the lane center at the front axle  

The steering command is computed as:

$$\delta = \psi_e + \arctan\left(\frac{k \cdot e}{v_x}\right)$$
