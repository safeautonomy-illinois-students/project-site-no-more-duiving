...
The following diagram illustrates how the longitudinal controller, Pure Pursuit controller, and Stanley controller interact within the system. It highlights how waypoint tracking and lane perception are combined to produce the final steering and speed commands.
...
The diagram shows the flow of information from perception (lane detection producing cross-track and heading error) and planning (waypoints), into the hybrid control system. Steering commands are generated by blending Pure Pursuit and Stanley outputs, while speed is controlled independently by the longitudinal controller.
...
::: {.hero-teaser}
{{< video static/videos/Controller_only.mp4>}}
:::
