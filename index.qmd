...
- **Perception model trained on real-world rosbags**, improving robustness beyond simulation  
- **Waypoint-following controller** (Pure Pursuit + PID) that accurately tracks predefined paths  
...
- Limited real-world closed-loop testing  
